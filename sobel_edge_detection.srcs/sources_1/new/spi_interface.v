...
module spi_interface(
    ...
    always @ (posedge i_sck or posedge i_cs)
    begin
        if (i_cs)
        begin
            curr_bit_r  <= 3'd7;
        ...
        begin
            ...
            data_in_gated     <= i_cs ? data_in_gated : { din_sr[pp_side_r][6:0], i_copi };
            // Each cycle process COPI bit
            din_sr[pp_side_r] <= { din_sr[pp_side_r][6:0], i_copi };
